        ...
        return(
            ...
            >
                { !this.props.course.isShow &&
                    <MediaBoxHeader>
                        <img src={this.props.course.maxPic} role="presentation" />
                    </MediaBoxHeader>
                }
                { this.props.course.isShow &&
                    <MediaBoxHeader>
                ...
                <MediaBoxBody className={this.props.router?'router':''}>
                    <MediaBoxTitle>{this.props.course.title}</MediaBoxTitle>
                    {
                        !this.props.sonCount&&
                        <MediaBoxDescription>
                            { this.props.course.isFather===1?('已经更新'+this.props.course.sonCount+'期|'+ (this.props.course.soldNumber===0 ? '欢迎订阅':(this.props.course.soldNumber + '人订阅 '))):(this.props.course.soldNumber===0 ? '欢迎订阅':(this.props.course.soldNumber + '人订阅 '))}
                        </MediaBoxDescription>
                    }
