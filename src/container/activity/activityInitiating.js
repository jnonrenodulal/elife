        ...
        return(
            <div className="initiateInfo">
                ...
                <div className="actInfoItem textArea">
                    <h4>活动简介:</h4>
                    <TextArea placeholder="对发起的活动的简短描述" rows="2" maxlength="220" onChange={this.handleChange.bind(this,3)} />
                </div>
                <div className="actInfoItem textArea">
                    <h4>备注信息:</h4>
                    <TextArea placeholder="您的特殊要求" rows="2" maxlength="220" onChange={this.handleChange.bind(this,4)} />
                </div>
