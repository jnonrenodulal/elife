...
class CommentList extends Component{
    ...
    handleChange(e){
        ...
        console.log("token="+cookie.load('userId'))
    ...
    render(){
        ...
        return(
            <div>
                ...
                <div id="publishCmt">
                    <div className="img" onClick={this.imgClick.bind(this,fatherId)}>
                ...
                <Popup show={this.state.fullpage_show}>
                    <HeaderBar content="添加图片" type="3" onClick={this.handleImg.bind(this)}/>
