...
class Login extends Component{
    constructor(props){
        ...
        this.state = {
            ...
            base64: '', //图片
            idArray: [] ,//需要上传的兴趣id列表
            phoneValue: this.props.location.query.isPhone || '',
        ...
        return(
            <div id="login">
                    ...
                    <div className="login">
                        ...
                        <div className="content">
                            ...
                            <div className="pass_reg">
                                <span className="forget_password" onClick={()=>{
                                    changeTab('forget');
                                }}>忘记密码</span>
                ...
                { (tab==="forget"||tab==="reset")  &&
                    <div className="login">
                        <div id="back" onClick={
                            tab==='forget' ? ()=>{this.props.location.query.isChangePassWord === '1'?location.hash = '#/myInfo':changeTab('login')} : ()=>{changeTab('forget')}
                        }>
                        ...
                        <div className="contentTwo">
                            { tab==="forget"  &&
                                <div>
                                    <LoginInput typeStr="tel" placeholder="请输入手机号" disabled={this.props.location.query.isPhone} phoneValue={this.state.phoneValue}  getValue={this.getInputValue.bind(this)} />
                                        ...
                                        <div className="yhm_sr">
                                            ...
                                            { !disable &&
                                                <Button id="getCaptcha"
                                                        ...
                                                        size="small"
                                                        onClick={()=>{
                                                                shouldFetchGetInfo({phone: this.props.location.query.isChangePassWord === '1'?this.state.phoneValue:this.state.phone} ,3);
                                    ...
                                    <button className="but_dl"
                                            onClick={()=>{
                                                shouldFetchGetInfo({
                                            phone: this.props.location.query.isChangePassWord === '1'?this.state.phoneValue:this.state.phone,
                            ...
                            { tab==="reset" &&
                                <div>
                                    ...
                                    <button className="but_dl" onClick={()=>{
                                            shouldFetchGetInfo({
                                ...
                                <div className="yhm_sr">
                                    ...
                                    { !disable &&
                                        <Button id="getCaptcha"
                                                ...
                                                size="small"
                                                onClick={()=>{
                                                    shouldFetchGetInfo({phone: this.state.phone} ,3 ,2);
