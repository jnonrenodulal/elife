    ...
    render(){
        ...
        return(
            <div id="user" className="panel panel-default">
                ...
                <Dialog title={this.state.style2.title} buttons={this.state.style2.buttons} show={this.state.diaLogShow}>确定要退出登录吗?</Dialog>
                ...
                <ul>
                    <MyLi title="我的订单" content="查看全部订单"
                          onClick={this.handleGotoOrder.bind(this, 0)}
                    />
                    <li className="menu">
                        {
