        ...
        case DONE_GET_ActList:
            return{
                ...
                activity:{
                   ...
                   /* list:action.isRefresh?action.data.list:(action.data.currentPage===1?state.activity.list.splice(0,state.activity.length).concat(action.data.list):state.activity.list.concat(action.data.list)),*/
                    list: action.isRefresh ? state.activity.list.splice(0,state.activity.length).concat(action.data.list) : state.activity.list.concat(action.data.list),
