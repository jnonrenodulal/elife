        ...
        case DONE_GET_COURSELIST:
            if(action.typeValue===0){
                return{
                    ...
                    select:{
                        ...state.select,
                        list:action.page===1?state.select.list.splice(0,state.select.length).concat(action.list):state.select.list.concat(action.list),
                ...
                return{
                    ...
                    two4Class:{
                        ...state.two4Class,
                        list: action.page===1 ? state.two4Class.list.splice(0,state.select.length).concat(action.list): state.two4Class.list.concat(action.list) ,
