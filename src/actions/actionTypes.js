...
export const GET_BINDCIPHERTEXT_SUCCESS='GET_BINDCIPHERTEXT_SUCCESS'//绑卡
...
export const GET_CHECK_GOODS='GET_CHECK_GOODS';//确认收货
//  我的权益
export const SET_CARDLIST_STATE='SET_CARDLIST_STATE';
export const SET_EQUITYCARD_STATE='SET_EQUITYCARD_STATE';
export const CARD_SWIPE_CHOOSE='CARD_SWIPE_CHOOSE';
